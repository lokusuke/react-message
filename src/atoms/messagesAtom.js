...
import { dummyMessages, dummyChats } from "../mock/data";
import { loginUserAtom } from "./loginUserAtom";
...
// メッセージ部屋にメッセージを新規追加する関数Atom（Write-Only） Create
...
// メッセージ部屋の自分のメッセージを削除する関数Atom（Write-Only） Delete
...
// メッセージ部屋の自分のメッセージを更新する関数Atom（Write-Only）Update
...
// 選択しているメッセージ部屋IDをつかって、メッセージを取得する関数Atom（Read-Only）Read
...
// メッセージ部屋内の自分のどのメッセージを削除するかを保存するAtom
